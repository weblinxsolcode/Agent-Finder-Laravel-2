                ...
                <div class="card customShadow">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title">
                                Reports: <span class="text-primary">{{ $list->count() }}</span>
                            </h3>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="datatable table table-hover table-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ ucfirst($item->selling_status ?? "") }}
                                            </td>
                                            <td>{{ \Illuminate\Support\Str::limit($item->address, 50, $end='...') }}</td>
                                            <td>
                                                {{ $item->created_at->format('d M Y') }}
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.property.report.details', ['id' => $item->id]) }}" class="btn btn-primary btn-rounded btn-sm">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="text-center">
                                                                <p class="text-danger">
                                                                    Are you sure you want to remove this property report?
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('admin.delete.property.report', ['id' => $item->id]) }}" class="btn btn-danger btn-rounded">
                                                            Yes, Delete
                                                        </a>
                                                    </div>
                                                </div>
